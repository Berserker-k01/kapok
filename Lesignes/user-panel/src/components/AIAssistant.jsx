...
const AIAssistant = () => {
    ...
    const handleSend = async (e) => {
        ...
        // Simulation de réponse IA pour l'instant
        setTimeout(() => {
            const aiResponses = [
                "Je peux vous aider à optimiser vos descriptions de produits.",
                "C'est noté ! Je vais analyser vos données de vente.",
                "N'oubliez pas de vérifier vos commandes en attente.",
                "Voulez-vous que je génère une description pour votre dernier produit ?",
                "Je suis encore en phase d'apprentissage, mais je fais de mon mieux !"
            ]
